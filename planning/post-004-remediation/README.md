...
6. **Documentation gaps (high for OSS-readiness)** — no LICENSE, CONTRIBUTING.md, CHANGELOG.md, SECURITY.md, CODE_OF_CONDUCT.md at root. Root README is 22 lines. 12 src projects have no README. 2 have stub READMEs.
