...
- [x] T001 Create solution scaffolding files
...
- [x] T002 Create Rig.TUnit.Core csproj with stub classes
...
- [x] T003 Create Core.Tests.Unit csproj with test infrastructure
...
- [x] T004 [P] Write CustomConstructorFakerTests.cs (3 tests)
...
- [x] T005 [P] Write ServiceRemovalExtensionsTests.cs (7 tests)
...
- [x] T006 [P] Write EnvironmentDetectionTests.cs (4 tests)
...
- [x] T007 [depends: T004, T005, T006] Implement Core source classes and verify tests pass
...
- [x] T008 Create Rig.TUnit.Grpc csproj with stub classes
...
- [x] T009 Create Grpc.Tests.Unit csproj + proto + test infrastructure
...
- [x] T010 [P] Write MetadataHelperTests.cs (3 tests)
...
- [x] T011 [P] Write GrpcClientHelperTests.cs + HandlerHelperTests.cs (4 tests)
...
- [x] T012 [P] Write WebApplicationFactoryExtensionsTests.cs + GrpcServiceReplacementExtensionsTests.cs (6 tests)
...
- [x] T013 [depends: T010, T011, T012] Implement Grpc source classes and verify tests pass
...
- [x] T014 Create Rig.TUnit.SqlServer csproj with stub classes
...
- [x] T015 Create SqlServer.Tests.Unit csproj + test infrastructure
...
- [x] T016 Write InMemoryDbExtensionsTests.cs (3 tests)
...
- [x] T017 [depends: T016] Implement InMemoryDbExtensions.cs and verify unit tests pass
...
- [x] T018 Create SqlServer.Tests.Integration csproj + test infrastructure
...
- [x] T019 [P] Write SqlServerFixtureTests.cs (3 tests)
...
- [x] T020 [P] Write DbContextHelperTests.cs (4 tests)
...
- [x] T021 [P] Write SqlServerContainerExtensionsTests.cs (2 tests)
...
- [x] T022 [depends: T019, T020, T021] Implement SqlServerFixture, DbContextHelper, SqlServerContainerExtensions and verify integration tests pass
...
- [x] T023 Create Rig.TUnit.Redis csproj with stubs + Redis.Tests.Integration csproj
...
- [x] T024 [P] Write RedisFixtureTests.cs (3 tests)
...
- [x] T025 [P] Write RedisContainerExtensionsTests.cs (2 tests)
...
- [x] T026 [depends: T024, T025] Implement Redis source and verify integration tests pass
...
- [x] T027 Create Rig.TUnit.ServiceBus csproj with stubs + ServiceBus.Tests.Integration csproj + config
...
- [x] T028 [P] Write ServiceBusFixtureTests.cs (2 tests)
...
- [x] T029 [P] Write ListenerHelperTests.cs (5 tests)
...
- [x] T030 [P] Write ServiceBusEventSenderTests.cs (3 tests)
...
- [x] T031 [P] Write ServiceBusContainerExtensionsTests.cs (2 tests)
...
- [x] T032 [depends: T028, T029, T030, T031] Implement ServiceBus source and verify integration tests pass
...
- [x] T035 [P] Write CoreBenchmarks.cs, SqlServerBenchmarks.cs, GrpcBenchmarks.cs
...
- [x] T036 Finalize Rig.TUnit.slnx with all 13 projects
      File: `Rig.TUnit.slnx`
      Notes: Verify all 13 projects present: 6 under /src/, 7 under /tests/. Ensure XML structure is correct.

- [x] T037 [depends: T001-T036] Final verification against all success criteria
      Verify:
